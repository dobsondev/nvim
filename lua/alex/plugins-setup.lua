...
return packer.startup(function(use)
	...
	use("ThePrimeagen/vim-be-good") -- game to practice nvim
	use("bluz71/vim-nightfly-guicolors") -- prefered colour scheme
	...
	use("williamboman/mason-lspconfig.nvim") -- ties mason and nvim-lspconfig together
